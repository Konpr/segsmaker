...
def webui_req():
    time.sleep(1)
    pull(f"https://github.com/Konpr/segsmaker comfyui {WEBUI}")
    ...
    scripts = [
        f"https://github.com/Konpr/segsmaker/raw/main/script/SM/controlnet.py {WEBUI}/asd",
        f"https://github.com/Konpr/segsmaker/raw/main/script/SM/venv.py {WEBUI}",
        f"https://github.com/Konpr/segsmaker/raw/main/script/SM/Launcher.py {WEBUI}",
        f"https://github.com/Konpr/segsmaker/raw/main/script/SM/segsmaker.py {WEBUI}"]
...
def webui_widgets():
    if WEBUI.exists():
        ...
        x = [
            f"https://github.com/Konpr/segsmaker/raw/main/script/SM/controlnet.py {WEBUI}/asd",
            f"https://github.com/Konpr/segsmaker/raw/main/script/SM/venv.py {WEBUI}",
            f"https://github.com/Konpr/segsmaker/raw/main/config/comfyui/apotek.py {WEBUI}",
            f"https://github.com/Konpr/segsmaker/raw/main/script/SM/Launcher.py {WEBUI}",
            f"https://github.com/Konpr/segsmaker/raw/main/script/SM/segsmaker.py {WEBUI}"
        ]
